      ...
      RoadmapMainStep(
        ...
        subSteps: [
          RoadmapSubStep(
            ...
            resources: [
              RoadmapResource(type: 'course', title: 'HTML & CSS Fundamentals', provider: 'Karirvana Academy'),
              RoadmapResource(type: 'course', title: 'Responsive Web Design', provider: 'Web Masters'),
              RoadmapResource(type: 'certificate', title: 'HTML5 & CSS3 Certificate', provider: 'TechCert'),
              RoadmapResource(type: 'certificate', title: 'Web Design Fundamentals', provider: 'DesignPro'),
            ],
          ),
          RoadmapSubStep(
            id: '1-2',
            ...
            resources: [
              RoadmapResource(type: 'course', title: 'JavaScript Essentials', provider: 'CodeAcademy'),
              RoadmapResource(type: 'course', title: 'Modern JavaScript ES6+', provider: 'DevSkills'),
              RoadmapResource(type: 'certificate', title: 'JavaScript Developer Certificate', provider: 'JSCert'),
              RoadmapResource(type: 'certificate', title: 'Frontend JavaScript Mastery', provider: 'WebCert'),
            ],
          ),
          RoadmapSubStep(
            id: '1-3',
            ...
            resources: [
              RoadmapResource(type: 'course', title: 'React.js Complete Guide', provider: 'ReactMasters'),
              RoadmapResource(type: 'course', title: 'React Hooks & Context', provider: 'ModernReact'),
              RoadmapResource(type: 'certificate', title: 'React Developer Certificate', provider: 'ReactCert'),
              RoadmapResource(type: 'certificate', title: 'Frontend Framework Mastery', provider: 'FrameworkPro'),
            ],
          ),
        ],
      ),
      RoadmapMainStep(
        ...
        subSteps: [
          RoadmapSubStep(
            ...
            estimatedDuration: '2-3 minggu',
            resources: [
              RoadmapResource(type: 'certificate', title: 'Frontend Developer Professional', provider: 'TechCert'),
              RoadmapResource(type: 'certificate', title: 'React.js Specialist', provider: 'ReactCert'),
              RoadmapResource(type: 'certificate', title: 'Web Development Bootcamp', provider: 'CodeCamp'),
            ],
          ),
          RoadmapSubStep(
            id: '2-2',
            ...
            resources: [
              RoadmapResource(type: 'guide', title: 'CV Template untuk Developer', provider: 'CareerGuide'),
              RoadmapResource(type: 'guide', title: 'Panduan Menulis CV IT', provider: 'TechCareer'),
              RoadmapResource(type: 'tool', title: 'CV Builder Tool', provider: 'Karirvana'),
            ],
          ),
          RoadmapSubStep(
            id: '2-3',
            ...
            estimatedDuration: '2-3 minggu',
            resources: [
              RoadmapResource(type: 'course', title: 'Portfolio Website Development', provider: 'WebAcademy'),
              RoadmapResource(type: 'guide', title: 'Portfolio Best Practices', provider: 'DesignGuide'),
              RoadmapResource(type: 'tool', title: 'Portfolio Templates', provider: 'PortfolioHub'),
            ],
          ),
        ],
      ),
      RoadmapMainStep(
        ...
        subSteps: [
          RoadmapSubStep(
            ...
            estimatedDuration: '2-3 minggu',
            resources: [
              RoadmapResource(type: 'guide', title: 'Frontend Interview Questions', provider: 'InterviewPrep'),
              RoadmapResource(type: 'course', title: 'Technical Interview Mastery', provider: 'InterviewAce'),
              RoadmapResource(type: 'tool', title: 'Mock Interview Practice', provider: 'Karirvana'),
            ],
          ),
          RoadmapSubStep(
            id: '3-2',
            ...
            resources: [
              RoadmapResource(type: 'job', title: 'Frontend Developer - Tokopedia', provider: 'Tokopedia', location: 'Jakarta'),
              RoadmapResource(type: 'job', title: 'React Developer - Gojek', provider: 'Gojek', location: 'Jakarta'),
              RoadmapResource(type: 'job', title: 'Web Developer - Shopee', provider: 'Shopee', location: 'Jakarta'),
              RoadmapResource(type: 'job', title: 'Frontend Engineer - Traveloka', provider: 'Traveloka', location: 'Jakarta'),
              RoadmapResource(type: 'guide', title: 'Job Application Strategy', provider: 'CareerGuide'),
            ],
          ),
        ],
      ),
